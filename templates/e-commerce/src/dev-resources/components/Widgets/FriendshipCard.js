      ...
      <Row>
        <Col xl={9} lg={10} md={10} sm={10} xs={24}>
          <img
            ...
            alt="..."
            src={require("assets/images/widget/sarfing.png")}
          />
        </Col>
          ...
          <div className="gx-fnd-content">
            ...
            <ul className="gx-fnd-gallery-list">
              <li>
                <img
                  alt="..."
                  src={require("assets/images/widget/sager.jpg")}
              ...
              <li>
                <img
                  alt="..."
                  src={require("assets/images/widget/dil.jpg")}
                  className="gx-rounded-lg gx-img-fluid"
                />
              </li>
              <li>
                <img
                  alt="..."
                  src={require("assets/images/widget/ships.jpg")}
                  className="gx-rounded-lg gx-img-fluid"
                />
              </li>
            </ul>
