export const qlikConfig = {
  ...
  host: "qqqqq", // Qlik Sense Host
  secure: true, // Whether your host is secure of not (HTTPS / HTTP)
  port: null, // Qlik Sense site port
  prefix: "", // Prefix
  appId: "qqqq", //"0294cf88-eb02-484a-b315-cf06b45ac347" Application Id
  webIntId: "qqqqqqq", //"4Tx-ydWxSQEM_q1ajlYBVzGgVUVJUo-i" Web Integration Id, for connection to Qlik cloud
