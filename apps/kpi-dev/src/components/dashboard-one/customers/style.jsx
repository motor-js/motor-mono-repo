...
import styled, { themeGet, space, device, layout } from "../../../styled";
import { CardHeader, CardFooter, Dropdown } from "../../../components";
...
export const StyledNavLink = styled(({ display, ...rest }) => <a {...rest} />)`
  padding: 0;
  color: ${themeGet("colors.text3")};
  display: none;
  &:not(:first-of-type) {
