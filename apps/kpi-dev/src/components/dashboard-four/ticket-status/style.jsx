import styled, { device, color as colorStyle, themeGet } from "../../../styled";
...
export const StyledBullet = styled(({ bg, ...rest }) => <span {...rest} />)`
  display: inline-block;
  border-radius: 50%;
  height: 7px;
  margin-right: 5px;
...
export const StyledRate = styled(({ ...rest }) => <span {...rest} />)`
  ${colorStyle}
`;
